...
class TTReportGenerator(ReportGeneratorBase):
    ...
    def _build_replacements(self, event):
        ...
        # For TT report values: Manual, AOTA (part of OCCULT4), Occular, R-OTE, Other - Specify in Comments
        # Default: AOTA (part of OCCULT4)
        ote_value = self._determine_ote_value_tt()
        ...
        all_placeholders = [
            ...
            '{{TIMING}}', '{{TIMING_DEVICE}}', '{{OTE}}', '{{DETECTOR}}', '{{VIDEO_FORMAT}}',
    ...
    def _determine_ote_value_tt(self):
        """Determine the OTE (Occultation Timing Extraction) value for Trans-Tasman report
