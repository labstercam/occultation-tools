# occultation-tools
Tools for automating occultation observations. Includes tool for using SharpCap for fully automating observations using personal events announced in Occult Watcher Cloud
